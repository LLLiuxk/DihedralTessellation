...
#define Feature_Max 3
	...
	public:
		...
		vector<Point2f> extract_contour(vector<Point_f> contour_, vector<int> mark_p, vector<int> &feature_p, vector<int> &midmark_p, vector<vector<Point_f>> &four_place, int type);
